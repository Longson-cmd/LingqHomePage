        ...
        <div class="px-5 pb-2 ">
            ...
            <div class="flex ">
                ...
                <div class="flex border-l border-gray-400 px-2 gap-1 items-center flex-wrap text-xs">
                    ...
                    <button v-if="!openAddtag" @click="openAddtag = !openAddtag"
                    ...
                    <input v-else type="text" @keyup.enter="addTag" v-model="newTag"
                        class=" focus:outline-none focus:ring-0 px-2 p-0.5 rounded-md border border-gray-300 ">
                </div>
            </div>
        </div>
