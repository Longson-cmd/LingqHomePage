...
import ImportText from './homepage/component/ImportText.vue'
import ImportAudio from './homepage/component/ImportAudio.vue'
import importVocabulary from './homepage/component/importVocabulary.vue'
const range = ref([3, 5])
